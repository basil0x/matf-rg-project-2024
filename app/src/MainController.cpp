...
public:
    ...
    void MainController::draw_bar() {
        ...
        shader->set_vec3("dirLightDirection", dirLightDirection);
        shader->set_vec3("dirLightColor", dirLightColor);
        shader->set_float("dirLightIntensity", dirLightIntensity);

        shader->set_vec3("pointLightPos", pointLightPos);
        shader->set_vec3("pointLightColor", pointLightColor);
        shader->set_float("pointLightIntensity", pointLightIntensity);
    ...
    void MainController::draw_gui() {
            ...
            ImGui::DragFloat3("Direction", &dirLightDirection.x, 0.01f);
            ImGui::ColorEdit3("Dir Color", &dirLightColor.x);
            ImGui::SliderFloat("Dir Intensity", &dirLightIntensity, 0.0f, 3.0f);
            ImGui::SeparatorText("Point Light");
            ImGui::DragFloat3("Point Pos", &pointLightPos.x, 0.1f);
